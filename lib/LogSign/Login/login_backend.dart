...
class LoginController extends GetxController {
  ...
  Future<void> emailAndPasswordSignIn() async {
    try {
      ...
      FullScreenLoader.openLoadingDialog(
          'we are Processing', 'assets/images/Animation - 1711786081505.json');
  ...
  Future<void> googleSignIn() async {
    try {
      FullScreenLoader.openLoadingDialog('Logging you in...', 'assets/images/Animation - 1711786081505.json');
